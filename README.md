...
Para demo online gratuita, use o Blueprint `render.yaml`, que cria Web Service e PostgreSQL gratuitos. Para producao real, use `render.production.yaml` como referencia, com plano pago e disco persistente para uploads. Depois valide o ambiente com `docs/CHECKLIST_PRODUCAO_REAL.md`.
